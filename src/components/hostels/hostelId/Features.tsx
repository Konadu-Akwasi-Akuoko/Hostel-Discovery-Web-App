    ...
    <div className="mt-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 pt-4">
        ...
        <MdFeatureCard>
          ...
          <div>
            <p className="font-bold mb-1">No Security Guard</p>
            <p className="text-sm text-slate-10">
              There is no dedicated security guard on the hostel premises
            </p>
          </div>
        </MdFeatureCard>
      </div>
