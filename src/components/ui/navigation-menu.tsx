...
const navigationMenuTriggerStyleT = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-white px-4 py-2 text-[--tomato-11] text-sm font-medium transition-colors hover:bg-[--tomato-4] hover:text-slate-900 focus:bg-[--tomato-4] focus:text-slate-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-slate-100/50 data-[state=open]:bg-slate-100/50 dark:bg-slate-950 dark:hover:- dark:hover:text-white dark:focus:- dark:focus:text-white dark:data-[active]:bg-slate-800/50 dark:data-[state=open]:bg-slate-800/50"
);
